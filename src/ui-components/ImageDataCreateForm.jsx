...
import { createImageData } from "../graphql/mutations";
...
export default function ImageDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createImageData.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ImageDataCreateForm")}
      {...rest}
    >
      <TextField
        label="Image url"
